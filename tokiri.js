...
var copyrightCampaign = function(options) {
    ...
    setDefaultOption("bigText", 'Tällä hetkellä yhden musiikkikappaleen lataamisesta vertaisverkosta on rikoslaissa säädetty sama rangaistus kuin kuolemantuottamuksesta, pahoinpitelystä tai lapsikaappauksesta.');
    setDefaultOption("smallText", 'Allekirjoita <a href="https://www.kansalaisaloite.fi/fi/aloite/70" target="_blank">kansalaisaloite kohtuullisemman tekijänoikeuslain puolesta</a>.');
    ...
    var today = new Date();
    if (!(today.getDate() == 23 && today.getMonth() == 6) && options["onCampaignDayOnly"]) {
        return;
    }
